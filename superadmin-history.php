    ...
    <div class="row container-fluid">
        ...
        <div class="col col-lg-2  col-md-12 col-sm-12 col-xs-12 shadow-lg p-3 mb-5 bg-body rounded mt-5 maroon">
            ...
            <ul class="nav d-flex flex-column  align-items-center py-5 nav nav-pills nav-fill text-black-50 ">
                ...
                <li class="nav-item   w-100 border position-relative">
                    <a class="nav-link text-white" aria-current="page" href="super-admin.php">
                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger ">
                            <?php echo $data2 ?></span> New Inquiries </a>
                </li>
                <li class="nav-item active2 w-100 border">
                    <a class="nav-link text-black" aria-current="page" href="superadmin-history.php">History</a>
                </li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header maroon">
                        <h5 class="modal-title text-white" id="exampleModalLabel">Student Inquiry</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">

                        <form action="resolved-superadmin.php" method="post">
                            ...
                            <div class="col-12">
                                <label class="form-label mt-3">Student Number</label>
                                <input type="text" class="form-control" id="snumber" disabled>
                            </div>
                            <div class="col-12">
                                <label class="form-label mt-3">Student Name</label>
        ...
        <div class="col col-lg-10 col-md-12 col-sm-12 col-xs-12  ">
            <div class=" container-fluid mt-5 ">
                <div class=" container-fluid mt-5 shadow-lg p-3 mb-5 bg-body rounded border-top gradient">
                    ...
                    <?php
                    $sql = "SELECT id,status,fullname,email,type,student_number,date_time,reply,replied_by,replied_date,inquiry,remarks FROM inquiries WHERE status = 'replied'  ORDER by replied_date asc";
                    ...
                    <table id="history" class="table table-dark table-hover mt-3" style="width:100%">


                        <h1 class="fs-3 fw-bold my-3 text-white">Replied Inquiries</h1>
                        <hr>
                        <thead>
                            <tr>
                                <th>id</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td hidden class="overflow-auto"><?php echo $row['email']; ?></td>
