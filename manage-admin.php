...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE inquiries set id=$id,status = '$status',replied_date='$date' where id=$id";
    ...
    if ($result) {
        if ($status == 'ebrahman') {
            $sql = "SELECT email,name from admin where usertype='Ebrahman Inquiry Admin'";
        ...
        if ($status == 'ubian') {
            $sql = "SELECT email,name from admin where usertype='Ubian Inquiry Admin'";
            $result2 = mysqli_query($connect, $sql);
            $row2 = mysqli_fetch_assoc($result2);
            $email = $row2['email'];
            $name = $row2['name'];
        ...
        echo "<script>alert('Sent Succesfuly')</script>";
            ...
            <div class=" shadow-lg p-3 mb-5 bg-body rounded mt-4  w-50 mx-auto gradient">
                <div class="container-fluid px-4 py-3">
                    <div class="row">
                        ...
                        <div class="header">
                            <h5 class="fw-bolder text-white py-3 px-3 fs-4  ">Assign To:</h5>
                        ...
                        <form method="post" class="px-5 py-5 ">
                            ...
                            <div class="col-12 mb-5">
                                <label class="form-label fw-bold text-white">Assign to</label>
                                <select class="form-select" aria-label="Default select example" name="status">
                                    <option value="ebrahman">Ebrahman Inquiry Admin</option>
                                    <option value="ubian">Ubian Inquiry Admin</option>
                            ...
                            <div class="col-12 my-4">
                                <button type="submit" name="submit" class="btn btn-outline-warning  py-3 px-5 w-100">Send</button>
                            </div>
