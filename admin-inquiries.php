        ...
        <div class="col col-lg-2  col-md-12 col-sm-12 col-xs-12 shadow-lg p-3 mb-5 bg-body rounded mt-5 maroon ">
            ...
            <ul class="nav d-flex flex-column justify-content-center align-items-center py-5 nav nav-pills nav-fill text-black-50 ">
                ...
                <li class="nav-item w-100 border">
                    <a class="nav-link text-white" aria-current="page" href="history.php">History</a>
                </li>
                <li class="nav-item w-100 border">
            ...
            <div class=" container-fluid mt-5 shadow-lg p-3 mb-5 bg-body rounded border-top"">
                ...
                <div class="row">
                    <div class="col col-lg-6">
                        <h1 class="fs-3 fw-bold my-3">Ubian Inquiries</h1>
                    </div>
                    <div class="col col-lg-6">
                    </div>
                ...
                <tbody>
                    <?php
                    $sql = "SELECT id,fullname,type,student_number,date_time,email   FROM inquiries WHERE status='ubian' ORDER by ID asc";
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<tr>
                                        ...
                                        <a href=\"manage.php?manage=$id\"><button class=\"btn btn-warning w-100\">Manage</button></a>
