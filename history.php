...
$query = "SELECT COUNT(id) as attmpt from inquiries where status='ubian'";
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption mt-2 px-3">
                        ...
                        <h5 class="fw-bolder text-center">Ubian Inquiries</h5>
        ...
        <div class="col col-lg-2  col-md-12 col-sm-12 col-xs-12 shadow-lg p-3 mb-5 bg-body rounded mt-5 maroon">
            ...
            <ul class="nav d-flex flex-column  align-items-center py-5 nav nav-pills nav-fill text-black-50 ">
                ...
                <li class="nav-item   w-100 position-relative border">
                    <a class="nav-link text-black" aria-current="page" href="admin-inquiries.php">
                ...
                <li class="nav-item w-100 border">
                    <a class="nav-link text-white" href="trashed.php">Trash</a>
                </li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Ubian Inquiry</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">

                        <form action="resolved.php" method="post">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="updateid" id="email" disabled>
                            </div>
                            <div class="col-12">
        ...
        <div class="col col-lg-10 col-md-12 col-sm-12 col-xs-12 ">
            <div class=" container-fluid mt-5">
                <div class=" container-fluid mt-5 shadow-lg p-3 mb-5 bg-body rounded border-top"">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT id,status,fullname,type,email,student_number,date_time,reply,replied_by,replied_date,inquiry,remarks FROM inquiries WHERE status = 'replied' and type = 'ubian,' ORDER by replied_date asc";
