...
if (isset($_POST['submit'])) {
  ...
  if ($result) {
    ...
    echo "<script>window.location = 'admin-inquiries2.php#section2'</script>";
    # code...
  } else {
    # code...
        ...
        <div class="container-fluid px-4 py-3">
          <div class="row">
            ...
            <div class="header">
              ...
              <a href="admin-inquiries2.php"><button type="button" class="btn-close btn-close-white" aria-label="Close"></button></a>
